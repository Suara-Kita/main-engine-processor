...
pub struct Config {
    ...
    pub fallback_llm_endpoint: String,
...
impl Config {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            fallback_llm_endpoint: env("FALLBACK_LLM_ENDPOINT", ""),
            fallback_llm_model: env("FALLBACK_LLM_MODEL", "qwen/qwen3.5-397b-a17b"),
            fallback_llm_api_key: env("FALLBACK_LLM_API_KEY", ""),
